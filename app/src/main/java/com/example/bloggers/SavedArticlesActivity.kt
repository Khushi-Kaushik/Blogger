...
import com.example.bloggers.databinding.ActivitySavedArticlesBinding
...
class SavedArticlesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        blogAdapter = BlogAdapter(savedBlogArticles.filter { it.isSaved == true }.toMutableList())
        ...
        if(userId != null){
            val userReference = FirebaseDatabase.getInstance("https://bloggers-96929-default-rtdb.asia-southeast1.firebasedatabase.app/")
        ...
        val backButton = findViewById<ImageButton>(R.id.strokeButton)
    ...
    private suspend fun fetchBlogItem(postId: String): BlogItemModel? {
        val blogReference =
            FirebaseDatabase.getInstance("https://bloggers-96929-default-rtdb.asia-southeast1.firebasedatabase.app/")
                .getReference("blogs")
        return try {
